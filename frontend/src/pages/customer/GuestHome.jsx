...
export default function GuestHome() {
  ...
  return (
    <div className="guest-home-container">
      <header className="guest-nav-bar">
        <div className="guest-nav-bar-logo">
          <img src="/logo2.png" className="" />
        </div>

        <div className="guest-nav-bar-action">
          <a href="/login" className="t-orange-btn" >
            Login
          </a>
          <a href="/register" className="re-orange-btn" >
            Register
          </a>
        </div>
      </header>
            ...
            {!loading && !error && topRooms.map(room => (
              <div className="room-card" key={room.roomTypeId}>
                <div className="room-card-image">
                  {/* NOTE: Assuming RoomImage entity has an 'imageUrl' property */}
                  <img
      ...
      <footer>
        ...
        <div>
          <h3>Staff</h3>
          <a href="/staff/login">Login for Staff</a>
        </div>
